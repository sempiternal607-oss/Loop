...
export function MobileNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#07080C]/85 backdrop-blur-2xl border-t border-white/[0.08] px-4 py-2 flex items-center justify-around select-none shadow-2xl">
      {navItems.map((item) => {
